...
2. One-month filter --- plans only files matching a one-month timestamp range.
3. One-week filter --- plans only files matching a one-week timestamp range.
...
|---|---|---|---|
| None | 1509 | --- | --- |
| One month (2025-06-01T...) | 31 | 1478 | 97.9% |
| One week (2025-06-02T...) | 7 | 1502 | 99.5% |

## Observation

The narrowing is monotonic: a smaller predicate range excludes more files,
not fewer. None of the 1502 files skipped under the one-week filter were
